...
<head>
    ...
    <title>Unity WebGL Player | BombKing</title>
...
<body
    ...
    <h1 style="text-align: center;margin-top:75px;color:blule;text-decoration: underline;">BombKing</h1>
    <div id="unity-container" class="unity-desktop">
        ...
        <div id="unity-footer">
            ...
            <div id="unity-build-title">BombKing</div>
        </div>
        <p class="text-center ">
    ...
    var config = {
        dataUrl: buildUrl + "/BB.data.unityweb",
        frameworkUrl: buildUrl + "/BB.framework.js.unityweb",
        codeUrl: buildUrl + "/BB.wasm.unityweb",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "JStudio",
        productName: "BombKing",
        productVersion: "1.0",
